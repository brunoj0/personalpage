...
export default component$(() => {
  return (
        <div class="text-white w-228 p-5">
            <h4>Hi,</h4>
            <h1 class="text-3xl xl:text-4xl">My name is BRUNO</h1>
            <h2 class="text-2xl xl:text-3xl text-cyan-5 mt-6 tracking-widest">I am a front-end developer</h2>
